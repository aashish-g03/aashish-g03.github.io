...
class _LoadingHomePageAnimationState extends State<LoadingHomePageAnimation>
  ...
  Widget build(BuildContext context) {
    ...
    double widthOfLeftLine =
        max(assignWidth(context, 0.5) - (textWidth / 2), 0);
    double widthOfRightLine =
        max(screenWidth - (widthOfLeftLine + textWidth), 0);
    double leftContainerStart = max((screenWidth / 2) - (textWidth / 2), 0);

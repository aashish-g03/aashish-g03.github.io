...
class ImagePath {
  ...
  //Images
  static const String DEV = "$imageDir/aashish_gupta.png";

  static const String VYBZ = "$imageDir/vybz.jpg";
  static const String DEV_PROFILE = "$imageDir/dev_profile.png";
  ...
  static const String COURSERA_ML_CERT =
      "$imageDir/CourseraMachineLearning.jpg";
  static const String COURSERA_SWIFT_CERT =
      "$imageDir/Coursera 278ZUKY6AUVA.png";

...
class Data {
  ...
  static List<CertificationData> certificationData = [
    CertificationData(
      title: StringConst.COURSERA_ML,
      url: StringConst.COURSERA_ML_CERT,
      image: ImagePath.COURSERA_ML_CERT,
      imageSize: 0.325,
      awardedBy: StringConst.DUKE_UNIVERSITY,
    ),
    CertificationData(
      title: StringConst.COURSERA_SWIFT,
      url: StringConst.COURSERA_SWIFT_CERT,
      image: ImagePath.COURSERA_SWIFT_CERT,
      imageSize: 0.325,
      awardedBy: StringConst.META,
    ),
    // CertificationData(
